...
import { MDBCardGroup, MDBCardImage, MDBBtn, MDBCard, MDBCol, MDBCardBody, MDBCardHeader } from "mdbreact";
const ProjectData = [
...

    {
        ...
        tech: "HTML, CSS, Node.js, Express.js, Handlebars, MYSQL, Express, body-parser, handlebars",
        link: <a href="https://frineds-find.herokuapp.com/">Find out more</a>,
        image: Friend
    },
    ...
    render() {
        return (
            <MDBCardBody className='card-body p-1'>
                ...
                <p style={{ fontWeight: "bold", fontSize: "32px", textAlign: "center" }}>{this.props.title}</p>
