    ...
    return (
        <React.Fragment>
            <div className="about-page mdb-color darken-3t " id="about">
                <MDBCardHeader className="cardHead mask pl-5 " color="red accent-3 lighten-1" style={{ fontSize: "65px", paddingTop: "75px" }}>About Me!</MDBCardHeader>
                    <MDBContainer className="main justify-content-center" >
                        <article className="about-page-content ">
                            <MDBCol>
                                <MDBRow className="about-header">
                                    <p className="about-name text-white" style={{ fontSize: "65px" }}>Hi, I'm Yasiin Muhammad </p>
                                </MDBRow>
                            </MDBCol>
                            {/* <MDBRow>
                                <MDBCol> */}
